...
| v0.4.1 production GP/LCB wiring | Wire risk penalty into the live engine | `qe_active_inverse_common.py`, `reports/failure_aware_gp_acquisition_v041.md` | Same 50/36 ranking, with tested LCB-fallback property | Old LCB behavior is preserved by a tested code contract, not convention | Still validated offline only |
