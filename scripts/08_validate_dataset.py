...
def main() -> int:
    ...
    reliable_path = PROJECT_ROOT / "data" / "processed" / "reliable_subset_v0.csv"
...
def build_report(rows: list[dict], label_counts: Counter) -> str:
    lines = []
    ...
    lines.append(f"Generated by `scripts/08_validate_dataset.py` (validator_version {VALIDATOR_VERSION}) "
                  "from `data/processed/initial_relax_parsed_v0.1.json`.")
    lines.append("")
