"""Active learning + inverse design for Perovskite SrTiO3."""
...
def build_bulk_srtio3(a: float):
    return build_perovskite('Sr', 'Ti', 'O', a)


SYSTEM = ActiveSystem(
    key='bulk_srtio3',
    title='Perovskite SrTiO3',
    builder=build_bulk_srtio3,
    variables=(
        Variable("a", 3.75, 4.05, (3.8, 3.9, 4.0)),
    ),
    pseudopotentials={'Sr': 'Sr_pbe_v1.uspp.F.UPF', 'Ti': 'ti_pbe_v1.4.uspp.F.UPF', 'O': 'O.pbe-n-kjpaw_psl.0.1.UPF'},
    ecutwfc=70.0,
    ecutrho=560.0,
    kpts=(6, 6, 6),
    smearing='gaussian',
